...
export class McpServerManager {
	...
	private static providers: Set<SheetsProvider> = new Set()
	 ...
	 */
	static async getInstance(context: vscode.ExtensionContext, provider: SheetsProvider): Promise<McpHub> {
	 ...
	 */
	static unregisterProvider(provider: SheetsProvider): void {
