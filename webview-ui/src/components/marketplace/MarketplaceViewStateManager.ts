 ...
 *
 * This class manages the state for the marketplace view in the Sheets IDE extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Sheets IDE extensions interface
